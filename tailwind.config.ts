    ...
    extend: {
      ...
      colors: {
        ...
        category: {
          ...
          "medical-bg": "hsl(var(--category-medical-bg))",
          education: "hsl(var(--category-education))",
          "education-bg": "hsl(var(--category-education-bg))",
          utility: "hsl(var(--category-utility))",
          "utility-bg": "hsl(var(--category-utility-bg))",
          insurance: "hsl(var(--category-insurance))",
          "insurance-bg": "hsl(var(--category-insurance-bg))",
